...
// To draw such mask use the [ebiten.ColorScale.ScaleWithColor] method with premultiplied color - combination of this
// color and mask will be correctly premultiplied:
//
